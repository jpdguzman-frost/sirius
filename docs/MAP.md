...
- Open blocking decision DL-scope: **The Deadlines Breakdown mixes two scopes.** DUE THIS MONTH / URGENT / CONFLICTS are month-scoped, NEEDS REPLOTTING is… → STATE.md §Decisions needed from JP (blocking)
