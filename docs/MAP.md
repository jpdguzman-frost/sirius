...
- Open blocking decision DL-scope: **The Deadlines Breakdown mixes two scopes** → STATE.md §Decisions needed from JP (blocking)
...
<!-- GEN:AREAS -->
- `frontend` — 34 files → docs/architecture/map-frontend.md — no-bundler Ractive app: numbered app scripts (one shared scope, filename order) + a template layout with numbered partials and views + numbered styles
