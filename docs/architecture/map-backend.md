...
- `src/services/rollover.ts` — the rollover job: late plotted rows walk to today one working day at a time, the sprint follows the finish day (owl #75 §2); nextFinishDay/sprintFor/rollUnfinished.
