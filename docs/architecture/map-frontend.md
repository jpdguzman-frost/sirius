...
- `frontend/scripts/50-gantt-geometry.js` — workday x-axis: TOTAL_UNITS, dayIndex, clampUnits, pctOf/unitPct, weekAtX + its day-grain sibling dayAtX (block 7), itemBar/itemPhase (the single urgency-coloured bar; phaseRun is retired) + app.set of itemBar/deadlineTick/plusLeft/sprintLength.
