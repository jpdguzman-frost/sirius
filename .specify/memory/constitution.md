...
Adopted verbatim from `CLAUDE.md` — the Sirius Build Constitution — per `docs/history/spec-kit-playbook.md`
Step 1 (a RECORD since 2026-08-18 — see its banner). Everything between here and the Governance section is the source document,
...
- **Source of truth.** `CLAUDE.md` is authoritative. If this file and `CLAUDE.md` diverge, this
  ...
  win, per `docs/history/spec-kit-playbook.md`.
