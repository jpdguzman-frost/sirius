...
- **Freshness**: everything documented is served from ARES cache. The guide documents a 30-minute worker cycle; **per JP (2026-08-03) the new ARES delivers in realtime** — NFR-3 (< 15 min) stands, verified end-to-end during phase 4. Gate on `/healthz` before rendering trust.
