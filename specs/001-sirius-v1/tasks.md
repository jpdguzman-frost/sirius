...
Two items **excluded pending JP** and deliberately not built: the FR-5.9 change (pins block Suggest only, allow manual drag) and the conflict-ack key gaining capacity (invariant 13 amendment / OD-4 slice).
