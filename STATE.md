...
- 2026-09-12 — **The swept document set ADOPTED** (JP: yes, and *follow theirs* on numbering): `docs/product/brd.md` is **BRD v3.0**, `implementation-plan.md` the swept engineering doc, `security-readiness.md` new — v2.2 and the 08-18 plan archived beside them. Closes the BRD §9 blocker open since 2026-08-04. **Product's numbering adopted twice**: ACs (their 1–26 stand, ours → AC-27–AC-30, AC-12/15/16/17 retire) and requirements (**FR-11 → FR-3.7–FR-3.10, FR-12 → FR-6.9–FR-6.14**; five sub-rules stay local; **FR-11.3/11.4 HELD** — v3.0's FR-3.3 still calls *For Clarification* a STATUS value, a third wording correction for product, unsent). Banners carry what the sweep does NOT override: the engineering doc's Postgres §1 (Stack wins) and `spec.md`'s body, still the v2.2 conversion — re-converting it is outstanding and waits on product. No behaviour changed; owls #98–#113 acked, #79 sent. Log: `docs/history/state-log/2026-09-12.md`.
